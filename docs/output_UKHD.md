...
$ salmon quant --geneMap Mus_musculus.GRCm39.dna.genome.filtered.gtf --threads 6 --libType=A \
...
$ salmon quant --geneMap Mus_musculus.GRCm39.dna.genome.filtered.gtf --threads 6 --libType=ISR \
...
$ tx2gene.py --quant_type salmon --gtf Mus_musculus.GRCm39.dna.genome.filtered.gtf --quants quants \
