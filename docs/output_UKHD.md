...
- `trimgalore/`
  - `*_val_1.fq.gz` and `*_val_2.fq.gz` : If `--save_trimmed` is specified, FastQ files **after** adapter trimming will be placed in this directory.
...
$ STAR \
    --genomeDir star \
    --readFilesIn $input1/*_val_1.fq.gz $input2/*_val_2.fq.gz \
    --runThreadN 12 \
